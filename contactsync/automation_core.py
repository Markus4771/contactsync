...
def init_schema() -> None:
    with connect() as connection:
        connection.executescript(
            ...
            CREATE TABLE IF NOT EXISTS automation_schedules (id INTEGER PRIMARY KEY AUTOINCREMENT,name TEXT NOT NULL UNIQUE,source TEXT NOT NULL,target TEXT NOT NULL,mode TEXT NOT NULL DEFAULT 'delta',interval_minutes INTEGER NOT NULL DEFAULT 60,enabled INTEGER NOT NULL DEFAULT 1,next_run_at TEXT,last_run_at TEXT,created_at TEXT NOT NULL,updated_at TEXT NOT NULL);
